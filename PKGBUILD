...
# currently has no screen locker 
# currently using KDE konsole, dragon, kate, Plasma system monitor
pkgname=rebornos-cosmic-cutefish
pkgver=0.1
pkgrel=0
pkgdesc='Cosmic package for RebornOS cutefish'
